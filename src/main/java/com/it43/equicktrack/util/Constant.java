...
public class Constant {
    ...
    public static final long LATE_RETURN_MINUTES = 30L; // 30 minutes
    public static final long OTP_EXPIRATION = 120L;
    public static final long BEFORE_RETURN_MINUTES = 15L;
